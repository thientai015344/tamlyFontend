export const placeInfo = [
  {
    id: 1,
    headerTitle: 'Đau họng',
    headerSubTitle: 'soluta numquam',
    headerText:
      'tình trạng đau và khó chịu ở vùng họng...',
    title: 'Molestias officia excepturi',
    description:
      'Lorem ipsum Ydolor sit amet consectetur adipisicing elit. Voluptates qui voluptate odio quod doloremque unde reprehenderit velit quaerat.',
    img: '.././images/sore_throat.png',
    maps:
  ...
  {
    id: 2,
    headerTitle: 'Sốt xuất huyết',
    headerSubTitle: 'commodi',
    headerText:
      'do virus là một nhóm các bệnh do một số họ virus...',
    title: 'Lorem unitye',
    description:
  ...
  },
  {
    ...
    headerText:
      'Một bệnh nhiễm virus, thường ảnh hưởng đến hệ hô hấp...',
    title:
